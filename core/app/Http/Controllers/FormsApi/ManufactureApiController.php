...
class ManufactureApiController extends Controller
{
    ...
    {
        $manufactures = $this->manufacture->orderBy('uuid','desc')->paginate(750);
        return response()->json(['data'=>$manufactures],201);
    }

    public function search(){
        return $this->manufacture->apiSearch();
    }
