      ...
      <div class="col-lg-12">
       ...
       <div class="panel panel-primary">
         ...
         <div class="panel-body">
           <div class="col-md-4">
            {!! Form::open(['route' => ['farm.logo'], 'id'=>'files','files'=>true]) !!}
            @if (count($errors) > 0)

            {!! form_errors($errors) !!}

            @endif
            <input type="hidden" name="farm_id" value="{{$farm->uuid}}">
            {!! Form::image(asset($farm->logo != '' ? 'assets/img/uploads/farms/'.$farm->logo : 'assets/img/uploads/farms/farm.jpg'), 'photo', array('class' => 'img-responsive')) !!}<br>
