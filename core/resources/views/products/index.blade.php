         ...
         <div id="panelDemo14" class="panel panel-primary">
            <div class="panel-heading">
                  ...
                  <ul role="tablist" class="nav nav-tabs" id="myTab">
                     ...
                     <li role="presentation" class="active"><a href="#list" aria-controls="messages" role="tab" data-toggle="tab" aria-expanded="false" class="btn btn-success btn-outline">Question Type</a>
                     </li>
                     ...
                     <li role="presentation" class=""><a href="#product" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false" class="btn btn-success btn-outline">Products</a>
                     </li>
                  </ul>
                     </div>
                     <div class="col-md-6">
            ...
            <div class="panel-body ">
               <div role="tabpanel">
                  ...
                  <div class="tab-content">
                     ...
                     <div id="product" role="tabpanel" class="tab-pane">
                        <div class="row">
